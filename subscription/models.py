...
#         Group,
#         related_name="subscription_user_set",
#         blank=True
#     )

#     user_permissions = models.ManyToManyField(
#         Permission,
#         related_name="subscription_user_permissions_set",
#         blank=True
#     )
...
# #### User Subscription
# class Subscription(models.Model):
#     # user = models.ForeignKey("authentication.User", on_delete=models.CASCADE, related_name="subscriptions")  # ✅ Ajout de related_name
#     user = models.OneToOneField(User, related_name='user_membership', on_delete=models.CASCADE)
