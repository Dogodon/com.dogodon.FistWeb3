# Generated by Django 5.1.1 on 2025-04-17 21:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "unique_together": {("save_by", "numero_client")},
            },
        ),
        migrations.CreateModel(
            name="Invoice",
            fields=[
                ...
                ("numero_invoice", models.PositiveIntegerField()),
                (
                    "customer",
                    models.ForeignKey(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("save_by", "numero_invoice"), name="unique_invoice_per_user"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="invoice",
            unique_together={("save_by", "numero_invoice")},
        ),
    ]
